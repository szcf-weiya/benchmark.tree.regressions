lst_real_data <-
list(abalone = c("Predicting the age of abalone from physical measurements.", 
"https://github.com/jbrownlee/Datasets", "https://raw.githubusercontent.com/jbrownlee/Datasets/refs/heads/master/abalone.csv"
), AirQuality = c("Air Quality", "https://archive.ics.uci.edu/dataset/360/air+quality", 
...
), Energy = c("Appliances Energy Prediction", "https://archive.ics.uci.edu/dataset/374/appliances+energy+prediction", 
...
), ResidentialBuilding = c("Residential Building", "https://archive.ics.uci.edu/dataset/437/residential+building+data+set", 
