...
lst_methods_paras = list(list(ntree = 100), list(ntree = 200), list(ntree = 500),
                         list(num_trees = 100, num_sweeps = 40),
                         list(num_trees = 200, num_sweeps = 40),
                         list(num_trees = 500, num_sweeps = 40),
                         list(num_trees = 200, num_sweeps = 20),
                         list(num_trees = 200, num_sweeps = 80),
